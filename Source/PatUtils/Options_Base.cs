...
namespace Source.PatUtils
{
    ...
    public class Options_Base : Screen
    {
        ...
        public override void LoadContent()
        {
            ...
            menu = new ButtonMenu(.0f, .1f, 1, 4, new Vector2(.15f, .2f), GameBase.Instance.Content.Load<SoundEffect>(".\\ButtonClick_1"), GameBase.Instance.Content.Load<SoundEffect>(".\\ButtonSelected_1"), Button.ButtonAlignment.LEFT);

            //Return to Main Menu
            BitmapFontButton bReturn = new BitmapFontButton(StaticSpriteBatch.Instance, font_normal, font_highlighted, font_pressed, "RETURN", new Vector2(.0f, .0f), Button.ButtonAlignment.LEFT)
            {
            ...
            //Windowed / Fullscreen
            BitmapFontButton bFullscreen = new BitmapFontButton(StaticSpriteBatch.Instance, font_normal, font_highlighted, font_pressed, "DISPLAY MODE", new Vector2(.0f, .0f), Button.ButtonAlignment.LEFT)
            {
            ...
            //Change Resolution
            BitmapFontButton bResolution = new BitmapFontButton(StaticSpriteBatch.Instance, font_normal, font_highlighted, font_pressed, "RESOLUTION", new Vector2(.0f, .0f), Button.ButtonAlignment.LEFT)
            {
            ...
            //Pixel Filtering
            BitmapFontButton bFiltering = new BitmapFontButton(StaticSpriteBatch.Instance, font_normal, font_highlighted, font_pressed, "PIXEL FILTERING", new Vector2(.0f, .0f), Button.ButtonAlignment.LEFT)
            {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            StaticSpriteBatch.Instance.DrawString(font_normal, "GAME OPTIONS", new Vector2(GameBase.Instance.ScreenWidth * .5f, GameBase.Instance.ScreenHeight * .1f), Color.White, 0.0f, new Vector2(font_normal.GetStringRectangle("GAME OPTIONS").Width / 2,.5f), GameBase.Instance.GetCurrentPixelScale(), SpriteEffects.None, 0.0f);
            ...
            if (editingResolution){
                ...
                StaticSpriteBatch.Instance.DrawString(font_normal, ResolutionString(), new Vector2(GameBase.Instance.ScreenWidth * .65f, GameBase.Instance.ScreenHeight * menu.getButtonAt(0, 2)._position.Y), Color.White, 0.0f, new Vector2(font_normal.GetStringRectangle(ResolutionString()).Width / 2, .5f), GameBase.Instance.GetCurrentPixelScale(), SpriteEffects.None, 0.0f);
            }
