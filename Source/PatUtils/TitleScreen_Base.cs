    ...
    public class TitleScreen_Base : Screen
    {
        ...
        public override void LoadContent()
        {
            ...
            */
            ...
            //START GAME BUTTON
            BitmapFontButton bStartGame = new BitmapFontButton(StaticSpriteBatch.Instance, font_normal, font_highlighted, font_pressed, "START GAME", new Vector2(.5f, .35f), Button.ButtonAlignment.CENTER);
            //bStartGame.OnPress = notifyButtonPressed;
            menu.addButtonAt(bStartGame, 0, 0);

            //OPTIONS BUTTON
            BitmapFontButton bOptions = new BitmapFontButton(StaticSpriteBatch.Instance, font_normal, font_highlighted, font_pressed, "OPTIONS", new Vector2(.5f, .45f), Button.ButtonAlignment.CENTER);
            bOptions.OnPress = LoadOptions;
            menu.addButtonAt(bOptions, 0, 1);

            //QUIT GAME
            BitmapFontButton bQuit = new BitmapFontButton(StaticSpriteBatch.Instance, font_normal, font_highlighted, font_pressed, "EXIT GAME", new Vector2(.5f, .55f), Button.ButtonAlignment.CENTER);
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            menu.Draw(gameTime);
            StaticSpriteBatch.Instance.DrawString(font_copyright, "Copyright 2018", new Vector2((GameBase.Instance.ScreenWidth() * .5f) - (font_copyright.GetStringRectangle("Copyright 2018").Width * .38f), (float)(GameBase.Instance.GraphicsDevice.Viewport.Height * .95)), Color.White, 0.0f, new Vector2(50, 1), 1.0f, SpriteEffects.None, 0.0f);
