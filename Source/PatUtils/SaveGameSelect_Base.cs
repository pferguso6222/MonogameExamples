    ...
    public class SaveGameSelect_Base : Screen
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            */
            ...
            StaticSpriteBatch.Instance.DrawString(font_normal, SaveGameUtility.Instance.SaveGameEntries[0].Name, new Vector2(GameBase.Instance.VirtualWidth * .3f, GameBase.Instance.VirtualHeight * 0.28f), Color.White, 0.0f, new Vector2(0.0f, .0f), GameBase.Instance.GetCurrentPixelScale(), SpriteEffects.None, 0.0f);
            StaticSpriteBatch.Instance.DrawString(font_normal, SaveGameUtility.Instance.SaveGameEntries[1].Name, new Vector2(GameBase.Instance.VirtualWidth * .3f, GameBase.Instance.VirtualHeight * 0.48f), Color.White, 0.0f, new Vector2(0.0f, .0f), GameBase.Instance.GetCurrentPixelScale(), SpriteEffects.None, 0.0f);
            StaticSpriteBatch.Instance.DrawString(font_normal, SaveGameUtility.Instance.SaveGameEntries[2].Name, new Vector2(GameBase.Instance.VirtualWidth * .3f, GameBase.Instance.VirtualHeight * 0.68f), Color.White, 0.0f, new Vector2(0.0f, .0f), GameBase.Instance.GetCurrentPixelScale(), SpriteEffects.None, 0.0f);
            StaticSpriteBatch.Instance.End();
        }
    }
}
